...
/**
 * Get recently modified or created meetings as 100 meetings per page
 */
const processMeetings = async (domain, hubId, q) => {
  ...
  while (hasMore) {
    ...
    for (const meeting of data) {
      ...
      const associationsResult = await hubspotClient.crm.objects.meetings.associationsApi.getAll(meeting.id, 'contact');
